						...
						while (!opcion.equals("0")) {
							...
							case "1":
								...
								do {
									...
									System.out.println(
											"Ingrese S si desea seguir agregando productos o ingrese N para dejar de ingresar productos a su compra y presione Enter");
									opcion3 = teclado.next();
								} while (opcion3.equals("S"));
								do {
									System.out.println(
											"Ingrese el metodo de pago 1-para EFECTIVO 2-para TARJETA y presione Enter");
									opcion3 = teclado.next();
						...
						while (!opcion.equals("0")) {
							...
							case "5":
								...
								do {
									...
									System.out.println(
											"Ingrese S si desea seguir agregando productos o ingrese N para dejar de ingresar productos y presione Enter");
